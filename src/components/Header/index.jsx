...
const Header = () => {
  ...
  return (
    <nav className="border-b-2 border-gray-200 px-4 md:px-40 h-20 flex items-center mx-auto my-0 bg-white">
      <div className="nav-container w-full flex justify-between md:justify-between items-center">
